...
export const useProductStore = create((set) => ({
    ...
    fetchProductsByCategory: async (category) => {
        ...
        try {
            ...
            toast.error(error.response.data.error || "An error occurred while fetching products by category.");
        }
    },
    ...
    toggleFeaturedProduct: async (productId) => {
        ...
        try {
            ...
            set({ loading: false });
            toast.error(error.response.data.error || "An error occurred while toggling the featured status.");
        }
    },
