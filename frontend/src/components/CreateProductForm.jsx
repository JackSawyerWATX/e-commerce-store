...
const CreateProductForm = () => {
    ...
    return (
        <motion.div
            className="bg-gray-900 shadow-lg rounded-lg p-6 mb-8 max-w-xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        >
            <motion.h2 className="text-2xl font-semibold mb-6 text-emerald-300">Create a New Product</motion.h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 block w-full p-2 border border-gray-600 rounded-md bg-gray-700 text-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                        required
                    />
                </div>
                ...
                <div className="mt-1 flex items-center">
                    <input
                        ...
                        className="sr-only"
                        accept="image/*"
                        onChange={handleImageChange} // Implement handleImageChange to set newProduct.image
                    />
                    <label
                        htmlFor="image"
