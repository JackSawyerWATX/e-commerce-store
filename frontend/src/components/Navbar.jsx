import { ShoppingCart, LogOut, Lock, LogIn, UserPlus, CarTaxiFront } from "lucide-react";
            ...
            <div className="container mx-auto px-4 py-3">
                <div className="flex flex-wrap items-center justify-between">
                    ...
                    <nav className="flex flex-wrap items-center gap-4">
                        ...
                        {user ? (
                            <button className="bg-gray-700 hover:bg-gray-500 text-white px-4 py-1 rounded-md flex items-center transition duration-300 ease-in-out"
                                onClick={logout} >
                                <LogOut size={18} />
